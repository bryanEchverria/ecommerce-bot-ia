...
import BotConfigurationWithChat from './components/BotConfigurationWithChat';
        ...
        <main className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 p-6 md:p-8 overflow-y-auto">
            <Routes>
              ...
              <Route path="/bot-config" element={<ProtectedRoute><BotConfigurationWithChat /></ProtectedRoute>} />
