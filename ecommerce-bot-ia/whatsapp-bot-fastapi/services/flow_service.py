...
def crear_orden_flow(order_id: str, monto: int, descripcion: str, client_id: str, db: Session) -> str:
    """
...
def get_client_id_for_phone(telefono: str) -> str:
    """
    Mapea teléfonos a client_ids para multi-tenant
    Basado en el mapeo existente del chat service
    """
    phone_to_client = {
        "+3456789012": "green_house",
        "+1234567890": "demo_company", 
        "+5678901234": "mundo_canino",
        "+9876543210": "test_store",
        "+56950915617": "green_house"
    }
    return phone_to_client.get(telefono, "unknown_client")