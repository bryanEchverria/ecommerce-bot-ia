...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({ isOpen, onClose, onConfirm, title, message }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex justify-center items-center p-4" aria-modal="true" role="dialog">
      <div className="bg-surface rounded-xl shadow-2xl w-full max-w-md animate-fade-in-up">
        <div className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="mt-0 text-left">
                <h3 className="text-lg font-semibold leading-6 text-on-surface" id="modal-title">{title}</h3>
                <div className="mt-2">
        ...
        <div className="p-4 bg-secondary/50 rounded-b-xl flex justify-end gap-4">
          <button type="button" onClick={onClose} className="bg-surface text-on-surface font-semibold py-2 px-4 rounded-lg border border-white/20 hover:bg-white/5 transition-colors">
            {t('common.cancel')}
          </button>
